...
HD_PWD='C:/Users/jiang/OneDrive/Vivado/Lab3/Prac/Prac.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lab3_practice.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lab3_practice.tcl
