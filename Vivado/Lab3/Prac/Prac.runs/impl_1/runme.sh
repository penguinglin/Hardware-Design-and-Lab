...
HD_PWD='C:/Users/jiang/OneDrive/Vivado/Lab3/Prac/Prac.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lab3_practice.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lab3_practice.tcl -notrace
