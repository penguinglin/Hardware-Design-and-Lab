...
HD_PWD='C:/Users/jiang/OneDrive/Vivado/Lab4/Prac/Prac/Prac.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lab4_Practice.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lab4_Practice.tcl
