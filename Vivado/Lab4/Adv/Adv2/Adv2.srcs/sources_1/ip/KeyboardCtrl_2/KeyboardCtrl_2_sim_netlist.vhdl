...
-- Date        : Sun Oct 19 14:56:53 2025
-- Host        : LAPTOP-TN84JATT running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim -rename_top KeyboardCtrl_2 -prefix
--               KeyboardCtrl_2_ KeyboardCtrl_0_sim_netlist.vhdl
...
entity KeyboardCtrl_2_Ps2Interface is
  port (
...
end KeyboardCtrl_2_Ps2Interface;

architecture STRUCTURE of KeyboardCtrl_2_Ps2Interface is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity KeyboardCtrl_2_KeyboardCtrl is
  port (
    err : out STD_LOGIC;
...
end KeyboardCtrl_2_KeyboardCtrl;

architecture STRUCTURE of KeyboardCtrl_2_KeyboardCtrl is
...
Ps2Interface_i: entity work.KeyboardCtrl_2_Ps2Interface
     port map (
...
entity KeyboardCtrl_2 is
  ...
  attribute NotValidForBitStream of KeyboardCtrl_2 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of KeyboardCtrl_2 : entity is "KeyboardCtrl_0,KeyboardCtrl,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of KeyboardCtrl_2 : entity is "yes";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of KeyboardCtrl_2 : entity is "KeyboardCtrl,Vivado 2019.2";
end KeyboardCtrl_2;

architecture STRUCTURE of KeyboardCtrl_2 is
begin
inst: entity work.KeyboardCtrl_2_KeyboardCtrl
     port map (
      PS2_CLK => PS2_CLK,
      PS2_DATA => PS2_DATA,
      clk => clk,
