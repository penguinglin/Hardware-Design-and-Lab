...
HD_PWD='C:/Users/jiang/OneDrive/Vivado/Lab4/Basic/Basic.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lab4_basic.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lab4_basic.tcl -notrace
