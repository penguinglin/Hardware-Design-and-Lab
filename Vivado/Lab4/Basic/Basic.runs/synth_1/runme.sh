...
HD_PWD='C:/Users/jiang/OneDrive/Vivado/Lab4/Basic/Basic.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lab4_basic.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lab4_basic.tcl
