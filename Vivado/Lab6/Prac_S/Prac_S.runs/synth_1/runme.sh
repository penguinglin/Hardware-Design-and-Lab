...
HD_PWD='C:/Users/jiang/OneDrive/Vivado/Lab6/Prac_S/Prac_S.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lab6_practice_slave.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lab6_practice_slave.tcl
