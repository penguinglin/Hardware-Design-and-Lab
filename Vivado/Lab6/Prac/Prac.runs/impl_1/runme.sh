...
HD_PWD='C:/Users/jiang/OneDrive/Vivado/Lab6/Prac/Prac.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lab6_practice_master.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lab6_practice_master.tcl -notrace
