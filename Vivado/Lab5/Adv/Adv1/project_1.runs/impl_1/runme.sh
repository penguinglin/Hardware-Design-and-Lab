...
HD_PWD='C:/Users/NTHU-328/Downloads/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lab5_1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lab5_1.tcl -notrace
