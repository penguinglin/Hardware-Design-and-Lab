...
HD_PWD='C:/Users/NTHU-328/Downloads/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lab5_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lab5_1.tcl
