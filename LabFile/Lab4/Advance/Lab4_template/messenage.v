...
module lab4_3(
    ...
    always@(posedge clk)begin
        if(state == INITIAL)begin
            ...
            if(been_ready && key_down[last_change] == 1'b1 && key_down[8'h1D] == 1 && have_key_down == 0)begin//按w
                case(sound_lev)
                    1:sound_lev <= 2;
                    2:sound_lev <= 3;
                    3:sound_lev <= 3;
            ...
            else if(been_ready && key_down[last_change] == 1'b1 && key_down[8'h1B] == 1 && have_key_down == 0)begin//按s
                case(sound_lev)
                    1:sound_lev <= 1;
                    2:sound_lev <= 1;
                    3:sound_lev <= 2;
...
//----state control---------------------------------------------------------------------------------------------------------
    ...
    always@(*)begin
        ...
        GUESS:begin
            if(been_ready && key_down[last_change] == 1'b1 && key_down[8'h5A] == 1 && have_key_down == 0)begin//按enter
                nxt_state <= FINAL;
            end 
            else if(been_ready && key_down[last_change] == 1'b1 && key_down[8'h2D] == 1 && have_key_down == 0)begin//按R
                nxt_state <= INITIAL;
            end
...
//----main----------------------------------------------------------------------------------------------------------------------
    always@(posedge clk,posedge rst_processed)begin
        if(rst_processed)begin
            ...
            if(last_state == FINAL && state == GUESS)begin//清空上次guess
                input_number <= 11;
                input_alpha <= 11;
                input_state <= 0;
            end
            else if(been_ready && key_down[last_change] == 1'b1 && have_key_down == 0 && key_down[8'h66])begin//輸入backspace
            ...
            else if(input_state == 0 && been_ready && key_down[last_change] == 1'b1 && have_key_down == 0)begin//輸入英文字
            ...
            else if(input_state == 1 && been_ready && key_down[last_change] == 1'b1 && have_key_down == 0)begin//輸入數字
...
//otherfunction----------------------------------------------------------------------------------------------------------------------
    ...
    always@(posedge clk)begin
        if(state == INITIAL)begin
            ...
            if(been_ready && key_down[last_change] == 1'b1 && key_down[8'h31] == 1 && have_key_down == 0)begin//按N
                LED[8] <= LED[0];
                LED[7] <= LED[8];
    ...
    function [6:0] num_trans;
        ...
        begin
            ...
            10: num_trans = 7'b1111111;//無顯示
            11: num_trans = 7'b0111111;//顯示--
...
module note_gen(
    ...
    always@(*)begin
        ...
        case(volume)
            ...
            2:begin`define silence   32'd50000000
`define c4  32'd262   // C4
