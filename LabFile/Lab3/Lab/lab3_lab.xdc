...
#     set_property IOSTANDARD LVCMOS33 [get_ports {slow}]
 set_property PACKAGE_PIN V16 [get_ports {end_count}]
    set_property IOSTANDARD LVCMOS33 [get_ports {end_count}]
#  set_property PACKAGE_PIN W16 [get_ports {end_light}]
#     set_property IOSTANDARD LVCMOS33 [get_ports {end_light}]
